        ...
        fetch('http://localhost:5000/review', {
            ...
            .then(data => {
                if (data) {
                    ...
                    history.push('/dashboard/seeReview')
                }
            });
        console.log(review);
                ...
                <div class="bg-white min-w-1xl flex flex-col rounded-xl shadow-lg">
                    ...
                    <div class="bg-gray-200 w-full flex flex-col items-center">
                        ...
                        <div class="w-3/4 flex flex-col">
                            <textarea rows="3" class="p-4 text-gray-500 rounded-xl resize-none" placeholder="Leave a message, if you want" onChange={(e) => setReview({ ...review, review: e.target.value, name: user.providerData[0].displayName, image: user.photoURL })}></textarea>
                            <button class="py-3 my-8 text-lg bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl text-white" onClick={handleSubmit}>Submit</button>
                        </div>
                    </div>
